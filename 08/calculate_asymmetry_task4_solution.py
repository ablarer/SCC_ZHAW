def calculate_asymmetry_task4_solution(r_bin, rel_diff, sfa_thresh):
    ...
    % Remarks: none
    % Example: sfa,sfa_major_axis,ind_major_axis,sfa_minor_axis,ind_minor_axis,asymmetry = calculate_asymmetry_task4_solution(r_bin, rel_diff,sfa_thresh)
...
# 3) Calculate the asymmetry value
    if (sfa_major_axis >=sfa_thresh and sfa_minor_axis >= sfa_thresh): asymmetry = 0 
    elif (sfa_major_axis >=sfa_thresh and sfa_minor_axis < sfa_thresh):asymmetry = 1
    elif (sfa_major_axis <sfa_thresh and sfa_minor_axis < sfa_thresh): asymmetry = 2
    else: asymmetry=float('NaN')
